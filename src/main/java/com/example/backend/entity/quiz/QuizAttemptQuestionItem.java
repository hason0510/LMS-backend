...
@Entity
@Table(name = "quiz_attempt_question_items")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@SQLDelete(sql = "UPDATE quiz_attempt_question_items SET is_deleted = true WHERE id = ?")
@SQLRestriction("is_deleted = false")
public class QuizAttemptQuestionItem extends BaseEntity {
    @Id
    ...
    private QuestionInteractionItem sourceItem;
}
